---------------------------------------------------------------------------------------
-- Postgresql Database Setup -- JamaMQ -- October 2014 --------------------------------
---------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------
...
CREATE OR REPLACE FUNCTION dequeueMessage(reqclient_ integer, partsender_ integer, queue_ integer, peek_ integer)
    RETURNS message AS
$BODY$
declare
